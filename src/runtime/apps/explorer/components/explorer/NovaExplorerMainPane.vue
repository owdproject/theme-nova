...
function onNavSplitterPointerDown(e) {
...
.nova-explorer-main-pane__splitter::before {
  content: "";
  position: absolute;
  left: 2px;
  top: 0;
...
.nova-explorer-main-pane__splitter:hover::after, .nova-explorer-main-pane__splitter:active::after {
  content: "";
  position: absolute;
  inset: 0;
  background: color-mix(in srgb, var(--nova-explorer-text, #fff) 10%, transparent);
  pointer-events: none;
}
.nova-explorer-main-pane__splitter:focus-visible {
